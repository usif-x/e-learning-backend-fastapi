...
def get_teaching_greeting_system_message(language, user_name, session_type):
    if language == "ar":
        ...
        if session_type == "explaining":
            return f"""أنت معلم خبير ودود. مهمتك هي الترحيب بالطالب وشرح المحتوى له بطريقة واضحة.{student_name_instruction}
...
- مباشر للموضوع"""
        ...
        if session_type == "explaining":
            return f"""You are a friendly expert teacher. Your task is to welcome the student and explain the content to them clearly.{student_name_instruction}
...
def get_teaching_greeting_prompt(language, content_preview, session_type):
    if language == "ar":
        if session_type == "explaining":
            return f"""رحب بالطالب وابدأ بشرح المحتوى التالي:
...
ابدأ بترحيب قصير ثم اطرح سؤالًا واحدًا لاختبار الفهم الأساسي."""
        ...
        if session_type == "explaining":
            return f"""Welcome the student and start explaining the following content:
...
def get_teaching_response_system_message(language, user_name, session_type):
    if language == "ar":
        ...
        if session_type == "explaining":
            return f"""أنت معلم خبير تشرح المحتوى للطالب بطريقة واضحة ومبسطة.{student_name_instruction}
