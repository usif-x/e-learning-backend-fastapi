...
3. MARKDOWN FORMATTING: Use clean markdown formatting:
   ✓ Headers: ## للعناوين الرئيسية, ### للعناوين الفرعية (استخدمها بحكمة)
   ✓ Lists: استخدم - للنقاط المهمة
   ✓ Tables: استخدمها **فقط** لما يكون في مقارنة حقيقية محتاجة جدول
   ✓ Bold: **للتأكيد** على المصطلحات والنقاط المهمة

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
📝 HOW TO EXPLAIN
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

اشرح المحتوى بشكل طبيعي ومفصل:

✅ **اشرح المحتوى بوضوح وتفصيل**
- ركز على فهم المفاهيم
- استخدم أمثلة عملية لما تكون مناسبة
- اربط المعلومات ببعضها بشكل منطقي

✅ **استخدم الجداول بذكاء**
- استخدم جدول **فقط** لما يكون في مقارنة واضحة بين حاجتين أو أكتر
- مثلاً: مقارنة بين أمراض، أدوية، أعراض، classifications
- **لو مفيش مقارنة واضحة، ماتعملش جدول**

✅ **نبّه على الـ Confusion**
- لو في مفهوم ممكن يتلخبط مع مفهوم تاني، نبه الطالب:
  - "⚠️ **خلي بالك**: الـ X ممكن تتلخبط مع الـ Y"
  - وضّح أوجه التشابه والاختلاف بينهم بوضوح
  - ساعد الطالب يفرق بينهم

✅ **لو في أخطاء في المحتوى**
- لو لقيت معلومة غلط أو غير دقيقة، نبه عليها
- اشرح الصح إيه

⚠️ **مش لازم كل صفحة يكون فيها:**
- مش لازم جدول في كل صفحة
- مش لازم قسم "نصائح للحفظ" في كل صفحة
- مش لازم "ملخص سريع" في كل صفحة
- **اشرح بشكل طبيعي حسب المحتوى**
...
✓ "ببساطة" (simply)
✓ "عشان كده" (that's why)
✓ "خلي بالك" (be careful/pay attention)
...
Use tables **ONLY** when there's a clear comparison needed:
✓ Comparing diseases, symptoms, treatments
✓ Showing classifications
✓ Differential diagnoses
✓ Drug comparisons

**Don't force tables** - if the content doesn't need a comparison, just explain it naturally.

Table format example (only when needed):
| المعيار | الخيار الأول | الخيار التاني |
|---------|-------------|--------------|
| **Symptoms** | ... | ... |
| **Treatment** | ... | ... |
...
Return ONLY a JSON object:
{
    "pages": [
        {
            "page_number": 1,
            "explanation": "## الموضوع (لو محتاج عنوان)\\n\\nالشرح المفصل هنا...\\n\\n(جدول لو محتاج فقط)\\n\\n⚠️ **خلي بالك**: تنبيه لو في confusion محتمل..."
        }
    ]
}
...
- Be natural and flexible in your explanations"""
...
✅ اشرح المحتوى بشكل واضح ومفصل عشان الطالب يفهم
✅ استخدم جداول **فقط** لو في مقارنة فعلاً محتاجة جدول
✅ نبه على أي confusion ممكن يحصل مع مفاهيم تانية
✅ لو في معلومات غلط في المحتوى، صححها
✅ استخدم markdown بشكل نظيف ومش مبالغ فيه

أرجع JSON فيه شرح طبيعي ومفصل لكل صفحة من الصفحات: {page_numbers}
...
{{
    "pages": [
        {{
            ...
            "explanation": "الشرح المفصل بالماركداون..."
        }}
    ]
}}
